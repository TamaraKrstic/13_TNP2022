...
\author{Marina Nešković, mi22184@alas.matf.bg.ac \\ Anja Petrović, mi22168@alas.matf.bg.ac \\ Tamara Krstić mi22096@alas.matf.bg.ac \\ Tamara Petrović mi22277@alas.matf.bg.ac \\  }
\date{11.11.2022.}
\maketitle

\abstract{
Internet marketing je oblik marketinga koji prati moderno razvijanje tehnologije. Prvi put se pojavio krajem 20. veka na novonastalim veb stranicama a kasnije se pojavljuje i u drugim oblicima. Najvažnije prednosti ovakvog marketinga bile bi dostupnost, pove\'{c}anje broja kupaca i njegov uticaj na mala i srednja preduze\'{c}a. Nažalost ovakav marketing ima i neke svoje mane kao sto su konkurencija i kopiranje. Iako internet marketing nije savršen veoma je koristan u spajanju tržišta koja su geografski udaljena.
\tableofcontents
...
U poređenju sa tradicionalnim marketingom u masovnim medijima,internet marketing je mnogo isplativiji. Internet marketing takođe ne zahteva  velika ulaganja kao šta su preduze\'{c}a radila u prošlosti sa marketingom u masovnim medijima. Ovakav marketing jeftiniji je u poređenju sa tradicionalnim, a u mnogim slučajevima veb lokacije mogu generisati saobra\'{c}aj čak i besplatno. Na slici \ref{fig:prednosti} možemo da vidimo rezultate istraživanja rađenog na ovu temu.
\cite{prednosti i mane}

\begin{center}
    \includegraphics[width=7cm]{13_KrsticPetrovicNeskovicPetrovic/slika.prednosti.marketinga.jpg}\\
...
\bibitem{uvod} Marketing Library,https://mailchimp.com/marketing-glossary/digital-marketing, 12.11.2022. 
\bibitem{istorija} Alex Trengove. \emph{Internet marketing}. 2021.

\bibitem{prednosti i mane} Yurovskiy, Vladislav \emph{Pros and cons of internet marketing} 2014.
\bibitem{elementi} IT-akademija.com,https://www.it-akademija.com/digitalni-marketing-kompletan-vodic,12.11.2022.
\bibitem{hollistic} Holistic digital solutions,https://holistic-digital.com/internet-marketing/,14.11.2022.
